...
// [SY]: Allows to adjust specific file
...
// MARK: - Adjusted..
@IBDesignable open class AnimationView: LottieView {
  ...
  override public var intrinsicContentSize: CGSize {
    ...
    open func adjustLayer(info: AnimationView.LayoutInfo) -> AnimationView.LayoutInfo {
        return info
    }
    
override public func layoutAnimation() {
    ...
    let tuple = adjustLayer(info: .init(position: position,
                                        transform: xform))
    position = tuple.position
    xform = tuple.transform
